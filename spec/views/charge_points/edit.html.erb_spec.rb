...
RSpec.describe "charge_points/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit charge_point form" do
    render

    assert_select "form[action=?][method=?]", charge_point_path(@charge_point), "post" do
